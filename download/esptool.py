...
RTC_CLK_CONF=0x3ff48070
UART_CLK_DIV_0=0x3ff40014#CLK_DIV
defalut_msb_table = [0,213,127 ,170 ,254 ,43  ,129 ,84  ,41  ,252 ,86  ,131 ,215 ,2   ,168 ,125 ,82  ,135 ,45  ,248 ,
                     172 ,121 ,211 ,6   ,123 ,174 ,4   ,209 ,133 ,80  ,250 ,47  ,164 ,113 ,219 ,14 ,90  ,143 ,37  ,
                     240 ,141 ,88  ,242 ,39  ,115 ,166 ,12 ,217 ,246 ,35  ,137 ,92  ,8   ,221 ,119 ,162 ,223 ,10  ,
                     160 ,117 ,33  ,244 ,94  ,139 ,157 ,72  ,226 ,55  ,99  ,182 ,28 ,201 ,180 ,97  ,203 ,30 ,74  ,
                     159 ,53  ,224 ,207 ,26 ,176 ,101 ,49  ,228 ,78  ,155 ,230 ,51  ,153 ,76  ,24 ,205 ,103 ,178 ,
                     57  ,236 ,70  ,147 ,199 ,18 ,184 ,109 ,16 ,197 ,111 ,186 ,238 ,59  ,145 ,68  ,107 ,190 ,20 ,
                     193 ,149 ,64  ,234 ,63  ,66  ,151 ,61  ,232 ,188 ,105 ,195 ,22,239 ,58  ,144 ,69  ,17 ,196 ,110 ,
                     187 ,198 ,19 ,185 ,108 ,56  ,237 ,71  ,146 ,189 ,104 ,194 ,23 ,67  ,150,60  ,233 ,148,65  ,235 ,
                     62  ,106 ,191 ,21 ,192 ,75  ,158,52  ,225,181,96  ,202,31,98  ,183,29 ,200,156,73  ,227,54  ,
                     25 ,204,102,179,231,50 ,152,77 ,48 ,229,79 ,154,206,27 ,177,100,114,167,13 ,216,140,89  ,243,
                     38  ,91  ,142,36 ,241,165,112,218,15 ,32 ,245,95 ,138,222,11 ,161,116,9 ,220,118,163,247,34 ,
                     136,93  ,214,3 ,169,124,40 ,253,87 ,130,255,42 ,128,85 ,1 ,212,126,171,132,81 ,251,46 ,122,
                     175,5  ,208,173,120,210,7 ,83 ,134,44 ,249]
...
class ESPLoader(object):
    ...
    def __init__(self, port=DEFAULT_PORT, baud=ESP_ROM_BAUD):
        ...
        #self.EFUSE BLOCK0
        self.EFUSE_BLK0_RDATA0=0x6001a000
        self.EFUSE_BLK0_RDATA1=0x6001a004
        self.EFUSE_BLK0_RDATA2=0x6001a008
        self.EFUSE_BLK0_RDATA3=0x6001a00C
        self.EFUSE_BLK0_RDATA4=0x6001a010
        self.EFUSE_BLK0_RDATA5=0x6001a014
        self.EFUSE_BLK0_RDATA6=0x6001a018
    
        #self.EFUSE BLOCK1-3 RD
        self.EFUSE_BLK1_RDATA0=0x6001a038
        self.EFUSE_BLK1_RDATA1=0x6001a03c
        self.EFUSE_BLK1_RDATA2=0x6001a040
        self.EFUSE_BLK1_RDATA3=0x6001a044
        self.EFUSE_BLK1_RDATA4=0x6001a048
        self.EFUSE_BLK1_RDATA5=0x6001a04c
        self.EFUSE_BLK1_RDATA6=0x6001a050
        self.EFUSE_BLK1_RDATA7=0x6001a054
    
        self.EFUSE_BLK2_RDATA0=0x6001a058
        self.EFUSE_BLK2_RDATA1=0x6001a05C
        self.EFUSE_BLK2_RDATA2=0x6001a060
        self.EFUSE_BLK2_RDATA3=0x6001a064
        self.EFUSE_BLK2_RDATA4=0x6001a068
        self.EFUSE_BLK2_RDATA5=0x6001a06C
        self.EFUSE_BLK2_RDATA6=0x6001a070
        self.EFUSE_BLK2_RDATA7=0x6001a074
    
        self.EFUSE_BLK3_RDATA0=0x6001a078
        self.EFUSE_BLK3_RDATA1=0x6001a07C
        self.EFUSE_BLK3_RDATA2=0x6001a080
        self.EFUSE_BLK3_RDATA3=0x6001a084
        self.EFUSE_BLK3_RDATA4=0x6001a088
        self.EFUSE_BLK3_RDATA5=0x6001a08C
        self.EFUSE_BLK3_RDATA6=0x6001a090
        self.EFUSE_BLK3_RDATA7=0x6001a094
    ...
    def connect(self, mode='default_reset', max_time=5):
...
class ESP8266ROM(ESPLoader):
    ...
    def get_mac(self):
        if True: #chip_type == "ESP8266" or chip_type == "ESP8285":
            retry_times = 3
            cal_crc = False
            try:
            ...
            efuse_check_res = True #for debug
            ...
            efuse_flg = (efuse_reg>>79)&0x1
            chip_flg = (efuse_reg>>77)&0x7
            bit_flg = (efuse_reg>>76)&0x1
            ...
            if chip_flg == 0:
                ...
                if bit_flg==0x0:
                    ...
                    #print( "CUSTOM_ID: %02X %02X %02X %02X %02X %02X %02X %02X "%(id7,id6,id5,id4,id3,id2,id1,id0))
                    self.CUSTOM_ID = "%02X%02X%02X%02X%02X%02X%02X%02X"%(id7,id6,id5,id4,id3,id2,id1,id0)
    ...
    def set_mac(self,bit_flg):
        if True: #self.chip == 'ESP8266' or self.chip=="ESP8089" or self.chip == "ESP8285":
            if bit_flg == 0:
                if self.MAC_FLG ==0:
            ...
            ESP8266_MAC = ":".join(self.ESP_MAC_STA.split("-"))
            return ESP8266_MAC

    def esp_crc8(self, dlist):
        crc = 0
        clen = len(dlist)
        for i in range(clen):
            crc = crc ^ dlist[i]
    ...
    def get_mac_status(self):
        return str(self.BIT_FLG)
        #return '1'
    
    def get_cus_mac(self, mode):
        if True: #chip_type == "ESP8266" or chip_type == "ESP8285":
            retry_times = 3
            cal_crc = False
            try:
            ...
            if chip_flg == 0:
                ...
                b2 = (efuse_reg>>60)&0xff
                b1 = (efuse_reg>>68)&0xff
                b0 = (efuse_reg>>80)&0xff
            ...
            if crc_cal_flg == 1:
                crc_efuse_4bit = ((reg0>>2)&0x03 ) | ((reg3>>28)&0x0c)
                crc_data = [b2,b1,b0]
                crc8_result = self.esp_crc8(crc_data)
                #print("now checking ccccccccrc")
                #print("crc8_result is:", crc8_result)
                crc8_mac_reg = (reg0>>8)&0xff
                #print("crc8_mac_reg is:", crc8_mac_reg)
                ...
                #print( "crc_efuse_4bit:",crc_efuse_4bit)
                #print( "crc_calc_4bit:",crc_calc_4bit)
            return self.set_cus_mac(self.BIT_FLG)
        
    def set_cus_mac(self,bit_flg):
        if True: #self.chip == 'ESP8266' or self.chip=="ESP8089" or self.chip == "ESP8285":
    ...
    def read_mac(self):
        ...
        tuple_mac = oui + ((mac1 >> 8) & 0xff, mac1 & 0xff, (mac0 >> 24) & 0xff)
        #print(tuple_mac)
        str_mac = ""
        for i in tuple_mac[0:5]:
            if(len(str(hex(i))) == 4):
                str_mac += str(hex(i)[2:4]) + ":"
            else:
                str_mac += "0" + str(hex(i)[2]) + ":"
        str_mac += str(hex(tuple_mac[5])[2:4])
        return str_mac
...
class ESP32ROM(ESPLoader):
    ...
    def get_mac(self):
        if True: #chip_type == "ESP32":        
        
            mac_l = self.read_reg(self.EFUSE_BLK0_RDATA1) &0xffffffff
            mac_h = self.read_reg(self.EFUSE_BLK0_RDATA2) &0xffffff
        
            efuse_blk0_d0 = self.read_reg(self.EFUSE_BLK0_RDATA0)
            efuse_blk0_d1 = self.read_reg(self.EFUSE_BLK0_RDATA1)
            efuse_blk0_d2 = self.read_reg(self.EFUSE_BLK0_RDATA2)
            efuse_blk0_d3 = self.read_reg(self.EFUSE_BLK0_RDATA3)
            efuse_blk0_d4 = self.read_reg(self.EFUSE_BLK0_RDATA4)
            efuse_blk0_d5 = self.read_reg(self.EFUSE_BLK0_RDATA5)
            efuse_blk0_d6 = self.read_reg(self.EFUSE_BLK0_RDATA6)
            self.efuse = "%08x%08x%08x%08x%08x%08x%08x"%(efuse_blk0_d0,efuse_blk0_d1,efuse_blk0_d2,efuse_blk0_d3,efuse_blk0_d4
                                                         ,efuse_blk0_d5,efuse_blk0_d6)
            #print "mac l: ",hex(mac_l)
            #print "mac h: ",hex(mac_h)
        
        
        
            read_mac=((mac_h&0xffff)<<32)|mac_l
            self.MAC0 = (read_mac>>40)&0xff
            self.MAC1 = (read_mac>>32)&0xff
            self.MAC2 = (read_mac>>24)&0xff
            self.MAC3 = (read_mac>>16)&0xff
            self.MAC4 = (read_mac>>8)&0xff
            self.MAC5 = (read_mac>>0)&0xff
        
            mac_tmp = [self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5]
            #mac_tmp.reverse()
            #crc_cal = self.calcrc(mac_tmp)
            #crc_read = (mac_h>>16)&0xff
            #crc_test = ((mac_h)>>24)&0xff
            #print "crc_cal:",crc_cal
            #print "crc_read:",crc_read
            #print "crc_test:",crc_test
            #if crc_read == crc_cal :
                            #print "ESP32 mac crc ok"
            #else:
                            #print "ESP32 MAC CRC FAIL"
                            #self.state = self.ESP_DL_EFUSE_ERROR
                            #self.append_log("set state: ESP_DL_EFUSE_ERROR\n")                
                            #return False
    ...
    def set_mac(self):
        if True: #self.chip == "ESP32":
            #self.print_dbg("48bit mac")
            mac = "%02X-%02X-%02X-%02X-%02X-%02X-"%(self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5)
            mac2 = "%02X%02X%02X%02X%02X%02X"%(self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5)
            mac = mac.upper()
            mac2 = mac2.upper()
            ...
            mac_sta ="%02X%02X%02X%02X%02X%02X"%(self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5)
            mac_ap ="%02X%02X%02X%02X%02X%02X"%(self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5+1)
            mac_bt ="%02X%02X%02X%02X%02X%02X"%(self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5+2)
            mac_etnet ="%02X%02X%02X%02X%02X%02X"%(self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5+3)
        
            #bt_mac = "%02X%02X%02X%02X%02X%02X"%(self.BLE_MAC_0,self.BLE_MAC_1,self.BLE_MAC_2,self.BLE_MAC_3,self.BLE_MAC_4,self.BLE_MAC_5)
        
            #self.print_dbg('MAC AP : %s'%mac_ap)
            #self.print_dbg('MAC STA: %s'%mac_sta)
            ######self.gen_bar(mac)
            self.ESP_MAC_AP = mac_ap
            self.ESP_MAC_STA = mac_sta
            self.ESP_MAC = mac_sta
            self.ESP_MAC_BT = mac_bt
            self.ESP_MAC_ETNET = mac_etnet
        
        
            #self.mp.textCtrl_BinPath3.SetValue("WiFi MAC:"+self.ESP_MAC_STA+'\n'+"BT MAC:"+self.ESP_BT_MAC )
            #self.mp.textCtrl_BinPath3.SetValue(mac_sta)        
            #self.mp.MAC=mac
            ESP32_MAC = ""
            for i in range (0,5):
                ESP32_MAC += self.ESP_MAC_STA[2*i : 2*i+2] + ':'
            ESP32_MAC += self.ESP_MAC_STA[10:12]
            
            return ESP32_MAC

    #def efuse_read_value(self,esp,block_index,word_index):
        ##Check the write data is ok
        #efuse_read(esp) 
        #read_value=esp.read_reg(EFUSE_READ_REG_TABLE[block_index][word_index])
        #return read_value

    #def get_xtal_fre(self):
        #uart__read_clk_div=(self.read_reg(UART_CLK_DIV_0)&0xFFFFF)
        #user_config_con_baudrate=self.user_sync_baud
        #user_calc_clk_div_40m=((40*1000000)/user_config_con_baudrate)
        #user_calc_clk_div_26m=((26*1000000)/user_config_con_baudrate)                      
        ##print "User Config Sync baudrae %u"%(user_config_con_baudrate)
        #if (abs(user_calc_clk_div_40m-uart__read_clk_div)<20):
            ##print "[ok]uart__read_clk_div=0x%x user_calc_clk_div_40m=0x%x user_calc_clk_div_26m=0x%x"%(uart__read_clk_div,user_calc_clk_div_40m,user_calc_clk_div_26m)
            #return 1
        #elif (abs(user_calc_clk_div_26m-uart__read_clk_div)<20):
            ##print "[ok]uart__read_clk_div=0x%x user_calc_clk_div_40m=0x%x user_calc_clk_div_26m=0x%x"%(uart__read_clk_div,user_calc_clk_div_40m,user_calc_clk_div_26m)
            #return 0
        #else:
            #print("[ERR]get xtal err uart__read_clk_div=0x%x user_calc_clk_div_40m=0x%x user_calc_clk_div_26m=0x%x"%(uart__read_clk_div,user_calc_clk_div_40m,user_calc_clk_div_26m))
            #raise FatalError("[ERR]get_xtal_fre")	
            #return 2
    
    #def efuse_init_for_esp32(self):
        ##print "efuse init timing"
        #clk_select=((self.read_reg(RTC_CLK_CONF)>>27)&(0x03)) 
        #if 1==clk_select:
            #print( "CLK is PLL(Fre=80MHz)")
            #self.write_reg(EFUSE_DAC_CONF,160,0xFF)
            #self.write_reg(EFUSE_CLK,(128<<8)|(80),0xFFFF)
            #if (160==(self.read_reg(EFUSE_DAC_CONF)&0xFF)) and (((128<<8)|(80))==(self.read_reg(EFUSE_CLK)&0xFFFF)):
                #pass	    
                #print( "[Ok]efuse init \n")
            #else :
                #print( "[ERR]efuse init \n")
                #print( "EFUSE_DAC_CONF=0x%x EFUSE_CLK=0x%x\n"%(self.read_reg(EFUSE_DAC_CONF),self.read_reg(EFUSE_CLK)))
    
        #elif 0==clk_select:
            ##print "CLK is XTAL(Fre=40/26MHz)"
            #xtal_fre=self.get_xtal_fre()
    
            #if 1==xtal_fre:
                #print( "[Ok]xtal_fre=40Mhz")
                #self.write_reg(EFUSE_DAC_CONF,80,0xFF)
                #self.write_reg(EFUSE_CLK,(255<<8)|(160),0xFFFF)
                #if (80==(self.read_reg(EFUSE_DAC_CONF)&0xFF)) and (((255<<8)|(160))==(self.read_reg(EFUSE_CLK)&0xFFFF)):
                    #print( "[Ok]efuse init \n")	    
                #else :
                    #print( "[ERR]efuse init \n")
                    #print( "EFUSE_DAC_CONF=0x%x EFUSE_CLK=0x%x\n"%(self.read_reg(EFUSE_DAC_CONF),self.read_reg(EFUSE_CLK)))	
            #elif 0==xtal_fre:
                #print( "[Ok]xtal_fre=26Mhz")
                #self.write_reg(EFUSE_DAC_CONF,52,0xFF)
                #self.write_reg(EFUSE_CLK,(255<<8)|(250),0xFFFF)	
                #if (52==(self.read_reg(EFUSE_DAC_CONF)&0xFF)) and (((255<<8)|(250))==(self.read_reg(EFUSE_CLK)&0xFFFF)):
                    #print( "[Ok]efuse init \n"	)    
                #else :
                    #print( "[ERR]efuse init\n")
                    #print( "EFUSE_DAC_CONF=0x%x EFUSE_CLK=0x%x\n"%(self.read_reg(EFUSE_DAC_CONF),self.read_reg(EFUSE_CLK)))	    
        ...
        #else :
            #print( "[Error] CLK select %d"%(clk_select))    

    def calcrc(self, crc_data):
        crc = 0
        nbytes = len(crc_data)
        for i in range (0, nbytes):
            crc = defalut_msb_table[(crc ^ crc_data[i]) & 0xff]
        return crc
    ...
    def get_mac_status(self):
        #EFUSE_BLK3_RDATA5_REG=0x3ff5a08c
        #status = self.read_reg(EFUSE_BLK3_RDATA5_REG)
        #status = (status>>24)&0x1
        #return str(status)
        return '1'
    ...
    def get_cus_mac(self, mode):
        ...
        if (mode == 0):
            ...
            if (self.get_mac_status() == "1"):
                EFUSE_BLK3_RDATA0_REG=0x3ff5a078
                EFUSE_BLK3_RDATA1_REG=0x3ff5a07c
                EFUSE_BLK3_RDATA2_REG=0x3ff5a080
                EFUSE_BLK3_RDATA3_REG=0x3ff5a084
                EFUSE_BLK3_RDATA4_REG=0x3ff5a088
                EFUSE_BLK3_RDATA5_REG=0x3ff5a08c
                EFUSE_BLK3_RDATA6_REG=0x3ff5a090  
            
                efuse_blk3_d0 = self.read_reg(EFUSE_BLK3_RDATA0_REG)
                efuse_blk3_d1 = self.read_reg(EFUSE_BLK3_RDATA1_REG)
                efuse_blk3_d2 = self.read_reg(EFUSE_BLK3_RDATA2_REG)
                efuse_blk3_d3 = self.read_reg(EFUSE_BLK3_RDATA3_REG)
                efuse_blk3_d4 = self.read_reg(EFUSE_BLK3_RDATA4_REG)
                efuse_blk3_d5 = self.read_reg(EFUSE_BLK3_RDATA5_REG)
                efuse_blk3_d6 = self.read_reg(EFUSE_BLK3_RDATA6_REG)
                self.efuse_reg = (efuse_blk3_d2<<64)|(efuse_blk3_d1<<32)|(efuse_blk3_d0)
    
                esp_mac_h = "%06x" %((self.efuse_reg>>8) & 0xffffff)   #get higher 32 bit from efuse
                esp_mac_l = "%06x" %((self.efuse_reg>>32)& 0xffffff)   #get lower 32 bit from efuse
                print("esp_mac is : %s %s" % (esp_mac_h, esp_mac_l))
    
                
                self.MAC0 = int(esp_mac_h[4:6], 16) #mac0 is the highest mac address byte
                self.MAC1 = int(esp_mac_h[2:4], 16)
                self.MAC2 = int(esp_mac_h[0:2], 16)
                self.MAC3 = int(esp_mac_l[4:6], 16)
                self.MAC4 = int(esp_mac_l[2:4], 16)
                self.MAC5 = int(esp_mac_l[0:2], 16)
            
                mac_tmp = [self.MAC0,self.MAC1,self.MAC2,self.MAC3,self.MAC4,self.MAC5]
                #print("mac_tmp:", mac_tmp)        
                return self.set_cus_mac()
            else:
                return "00:00:00:00:00:00"
        else:
            print("ESP EFUSE MODE IS WRONG!")
            return False            
    
    def check_xiaomi_mac(self, mac):

        #esptool_add_esp32.efuse_init_for_esp32(self)
        #reg0 = esptool_add_esp32.efuse_read_value(self,3,1)
        reg0 = self.read_reg(self.EFUSE_BLK3_RDATA0)
        #print("reg0 is %x" %reg0)
        reg0_0 = reg0 % 256
        reg0 //= 256
        reg0_1 = reg0 % 256
        reg0 //= 256
        ...
        reg1 = self.read_reg(self.EFUSE_BLK3_RDATA1)
        #print("reg1 is %x" %reg1)
        reg1_0 = reg1 % 256
        reg1 //= 256
        reg1_1 = reg1 % 256
        reg1 //= 256
        ...
        reg2 = self.read_reg(self.EFUSE_BLK3_RDATA2)
        #print("reg2 is %x" %reg2)
        reg2_0 = reg2 % 256
        reg2 //= 256
        reg2_1 = reg2 % 256
        reg2 //= 256
        ...
        reg3 = self.read_reg(self.EFUSE_BLK3_RDATA3)
        #print("reg3 is %x" %reg3)
        reg3_0 = reg3 % 256
        reg3 //= 256
        reg3_1 = reg3 % 256
        reg3 //= 256
        ...
        reg4 = self.read_reg(self.EFUSE_BLK3_RDATA4)
        #print("reg4 is %x"  %reg4)
        reg4_0 = reg4 % 256
        reg4 //= 256
        reg4_1 = reg4 % 256
        reg4 //= 256
        ...
        reg5 = self.read_reg(self.EFUSE_BLK3_RDATA5)
        #print("reg5 is %x"%reg5)
        reg5_0 = reg5 % 256
        reg5 //= 256
        reg5_1 = reg5 % 256
        reg5 //= 256
        ...
        crc_efuse_8bit = self.read_reg(self.EFUSE_BLK0_RDATA2)
        #print("crc_efuse_Read is %x" %crc_efuse_8bit)
        crc_efuse_8bit //= 256*256
        crc_efuse_8bit = crc_efuse_8bit % 256
        
        crc_data = []
        mac_temp = mac.split(":")        
        for i in range(0,6):
            crc_data.append(int(mac_temp[i],16))        
        #crc_data += [reg0_3, reg0_2, reg0_1, reg0_0, reg1_3, reg1_2, reg1_1, reg1_0, reg2_3, reg2_2, reg2_1, reg2_0, 
                    #reg3_3, reg3_2, reg3_1, reg3_0, reg4_3, reg4_2, reg4_1, reg4_0, reg5_3, reg5_2, reg5_1, reg5_0]
        crc_data += [reg0_0, reg0_1, reg0_2, reg0_3, reg1_0, reg1_1, reg1_2, reg1_3, reg2_0, reg2_1, reg2_2, reg2_3, 
                    reg3_0, reg3_1, reg3_2, reg3_3, reg4_0, reg4_1, reg4_2, reg4_3, reg5_0, reg5_1, reg5_2, reg5_3]        

        #print("crc_data", crc_data)
        crc_calc_8bit = self.calcrc(crc_data)

        if (crc_efuse_8bit == crc_calc_8bit):
            return mac
        else:
            return False
    ...
    def set_cus_mac(self):
        if True: #self.chip == "ESP32":
            ...
            crc_data = [self.MAC0, self.MAC1, self.MAC2, self.MAC3, self.MAC4, self.MAC5]
            crc8_result = self.esp_crc8(crc_data)
            #print("now checking CRRRRRRRRRC")
            crc8_mac_reg = self.efuse_reg&0xff
            if(crc8_result == crc8_mac_reg):
                pass
            else:
                print("CRC CHECK FAIL!")
    ...
    def write_mac_direct(self, mac_str):
        print(mac_str)
        EFUSE_BLK3_RDATA0=0x6001a078
        EFUSE_BLK3_WDATA0=0x6001A01c
        
        reg0 = self.read_reg(EFUSE_BLK3_RDATA0)
        print("reg0 is %x" %reg0)
        reg0 |= (0xff) << 8
        print("reg0 is %x" %reg0)
        self.write_reg(EFUSE_BLK3_WDATA0, reg0)
        time.sleep(1)
        reg0 = self.read_reg(EFUSE_BLK3_RDATA0)
        print("reg0 is %x" %reg0)
    ...
    def read_mac(self):
        ...
        try:
            tuple_mac = tuple(ord(b) for b in bitstring)           
        except TypeError:  # Python 3, bitstring elements are already bytes
            tuple_mac = tuple(bitstring)
        str_mac = ""
        for i in tuple_mac[0:5]:
            if(len(str(hex(i))) == 4):
                str_mac += str(hex(i)[2:4]) + ":"
